...
function OtherAppraiserInteractionList() {
    ...
    const { appraiser_interactions, updateInteractionDescription, currentAppraiser, updateFlaggedSupervisor, updateSupervisorName, updateAppraiserInteraction, updateInteractionStatus } = useGeneralStore();
